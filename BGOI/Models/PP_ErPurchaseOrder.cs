...
{
   public  class PP_ErPurchaseOrder
    {
        ...
        [DataFieldAttribute("GoodsType", "varchar")]
        public string GoodsType
        {
            get { return strGoodsType; }
            set { strGoodsType = value; }
        }
        private string strGoodsUnits;
        [DataFieldAttribute("GoodsUnits", "varchar")]
        public string GoodsUnits
        {
            get { return strGoodsUnits; }
            set { strGoodsUnits = value; }
        }

        private string strStockSituation;
        [DataFieldAttribute("StockSituation", "varchar")]
        public string StockSituation
        {
            get { return strStockSituation; }
            set { strStockSituation = value; }
        }
        ...
        private string strProjectPeople;
        [DataFieldAttribute("ProjectPeople", "varchar")]
        public string ProjectPeople
        {
            get { return strProjectPeople; }
            set { strProjectPeople = value; }
        }
        private string strContract;
        [DataFieldAttribute("Contract", "varchar")]
        public string Contract
        {
            get { return strContract; }
            set { strContract = value; }
        }
        private string strTsix;
        [DataFieldAttribute("Tsix", "varchar")]
        public string Tsix
        {
            get { return strTsix; }
            set { strTsix = value; }
        }
        private string strContractNoReason;
        [DataFieldAttribute("ContractNoReason", "varchar")]
        public string ContractNoReason
        {
            get { return strContractNoReason; }
            set { strContractNoReason = value; }
        }
        private string strSaleUnitPrice;
        [DataFieldAttribute("SaleUnitPrice", "varchar")]
        public string SaleUnitPrice
        {
            get { return strSaleUnitPrice; }
            set { strSaleUnitPrice = value; }
        }
        private string strContractTotal;
        [DataFieldAttribute("ContractTotal", "varchar")]
        public string ContractTotal
        {
            get { return strContractTotal; }
            set { strContractTotal = value; }
        }
        private string strFKexplain;
        [DataFieldAttribute("FKexplain", "varchar")]
        public string FKexplain
        {
            get { return strFKexplain; }
            set { strFKexplain = value; }
        }

        private string strProjectHK;
        [DataFieldAttribute("ProjectHK", "varchar")]
        public string ProjectHK
        {
            get { return strProjectHK; }
            set { strProjectHK = value; }
        }
