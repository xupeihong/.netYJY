        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.success == "false") {
                    ...
                    ShowIframe1("入库详细", "../FlowMeterManage/InStockDetail?Info=" + escape(texts), 500, 400, '');
                    //window.parent.OpenDialog("入库详细", "../FlowMeterManage/InStockDetail?Info=" + escape(texts), 700, 600, '');
                }
            }
        })
    })
...
function reload() {
    $("#list").jqGrid('setGridParam', {
        ...
        datatype: 'json',
        postData: {
            curpage: curPage, rownum: OnePageCountm, OrderDate: OrderDate
        },
    }).trigger("reloadGrid");
}
