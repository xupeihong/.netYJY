        ...
        success: function (data) {
            if (data.success == "false") {
                ...
                for (var k = 0 ; k < BakName.length; k++) {
                    ...
                    newTd1.className = "textright";
                    newTd1.style.width = "150px";
                    newTd1.innerHTML = "<input type='text' style='width:150px;' value='" + BakName[k] + "'  id='ProName" + j + "' onclick='SearchProduct(\"" + j + "\")'  readonly='readonly' />";

                    //规格型号
                    var newTd2 = newTr.insertCell();
                    newTd2.className = "textright";
                    newTd2.style.width = "150px";
                    newTd2.innerHTML = "<input type='text' value='" + BakType[k] + "' id='Spec" + j + "' type='text' style='width:150px;' readonly='readonly''/>";

                    //单位
                    var newTd3 = newTr.insertCell();
                    newTd3.className = "textright";
                    newTd3.style.width = "80px";
                    newTd3.innerHTML = "<input type='text' value='" + Measure[k] + "' id='Units" + j + "' type='text' style='width:80px;' readonly='readonly'/>";
        ...
        success: function (obj) {
            if (obj.success == "false") {
                ...
                for (var k = 1 ; k <= data.rows.length; k++) {
                    ...
                    str += "<td style='width:150px;' onclick='Voluation(this)'><lable id='ProName" + k + "' style='font-size:12px' >" + data.rows[k - 1]["ProName"] + "</lable>"
