...
$(document).ready(function () {
    ...
    $("#XGBJ").click(function () {
        ...
        if (rowid == null) {
            ...
            var id = jQuery("#list").jqGrid('getRowData', rowid).RID;
            window.parent.OpenDialog("修改确认单", "../FlowMeterManage/UpdateServicing?RID=" + id, 700, 500, '');
        }
    });
    ...
    $('#HZBJ').click(function () {
        ...
        if (str == "") { alert("请勾选报价单"); return; } else {
            window.parent.OpenDialog("确定单汇总", "../FlowMeterManage/ServicingSummary?RID=" + str+ "&CardType=" + $("#CardType").val(), 1100, 500, '');
