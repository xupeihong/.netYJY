            ...
            if (data.success == "false") {
                ...
                if (data.CheckItems != "") {
                    ...
                    $.each(datas.CheckItems, function (i, n) {
                        ...
                        if (i == 0) {
                            tr = $('<tr></tr>')
                            td = $("<td rowspan='2' colspan='2'>高频检测</td>");
                            td.appendTo(tr);
                        }
                        else if (i % 3 == 0) {
                            tr = $('<tr></tr>')
                            if (i / 3 == 2) {
                                td = $("<td rowspan='3' colspan='2'>低频检测</td>");
                                td.appendTo(tr);
                            }
                        }
                        ...
                        for (var key in n) {
                            ...
                            if (key == 'CheckContent') {
                                ...
                                if (arryContent.length > 1) {// 有选项
                                    ...
                                    td = $("<td style='text-align:center;'>" + n[key] + "</td>");
                                    td.appendTo(tr);
                                }
                            }
                        }
...
function FillData(data) {
    ...
    if (data.ChangeBakList != "") {
        ...
        var tr = $('<tr><td rowspan="' + countNum + '" style="width:10px;">更换部件</td><td colspan="2">名称</td><td colspan="2">规格型号</td><td>数量</td><td colspan="2">备注</td></tr>');
        tr.appendTo(tab);
