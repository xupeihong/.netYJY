            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.success == "true") {
                        ...
                        ShowIframe1("审批", "../COM_Approval/Approval?id=" + texts, 500, 400, '');
                    }
                    else {
                        return;
                    }
...
function jq() {
    ...
    jQuery("#list").jqGrid({
        ...
        colNames: ['', '计划单号', '计划月份', '创建人', '创建时间', '状态', 'State', '审批编号'],
        colModel: [
        { name: 'IDCheck', index: 'Id', width: 20 },
        { name: 'JHID', index: 'JHID', width: 150 },
        { name: 'Plannedmonth', index: 'Plannedmonth', width: 100 },
...
function select(rowid) {
    ...
    RelenvceID = jQuery("#list").jqGrid('getRowData', rowid).JHID;
    reload1();
    reload2(PID);
}
