...
$(document).ready(function () {
    ...
    $('#XZ').click(function () {
        ...
        window.parent.OpenDialog("新增内容", "../FlowSystem/AddBasic?id=" + sel, 400, 200, '');
    })
})
...
function reload() {
    ...
    $("#list").jqGrid('setGridParam', {
        ...
        { name: 'SID', index: 'SID', width: 200, hidden: true },
...
function UpdateType(xid, type, text) {
    window.parent.OpenDialog("修改内容", "../FlowSystem/UpdateBasic?Info=" + xid + "@" + type + "@" + text, 400, 200);
}
