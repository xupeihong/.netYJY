...
$(document).ready(function () {
    ...
    $("#btnPrint").click(function () {
        ...
        if (rowid == null) {
            ...
            var url = "PrintProductionStockIn?Info=" + escape(texts);
...
function AddProtoStockIn() {
    ...
    window.parent.parent.OpenDialog("新增入库单", "../InventoryManage/AddProductionStockIn", 800, 450);
...
function jq() {
    ...
    jQuery("#list").jqGrid({
        ...
        colNames: ['','序号', '入库单号', '入库批号', '科目', '入库时间', '经手人', '总金额', '库房类型', '所属仓库', '备注', '状态'],
        colModel: [
...
function jq1(ListInID) {
    ...
    jQuery("#list1").jqGrid({
        ...
        colNames: ['序号', '产品编号', '产品名称', '规格型号', '单位', '数量', '单价', '厂家', '备注', '生产组装单'],
        colModel: [
        { name: 'RowNumber', index: 'RowNumber', width: 50, align: "center" },
