...
$(document).ready(function () {
    ...
    $("#btnPrint").click(function () {
        ...
        if (rowid == null) {
            ...
            var url = "PrintProductionMaterials?Info=" + escape(texts);
...
function AddRetailSalesOut() {
    ...
    window.parent.parent.OpenDialog("新增出库单", "../InventoryManage/AddProductionMaterials", 800, 450);
...
function jq1(ListOutID) {
    ...
    jQuery("#list1").jqGrid({
        ...
        colNames: ['序号', '产品编号', '产品名称', '规格型号', '单位', '申请数量','实际数量', '单价', '厂家', '批号','备注','领料单'],
        colModel: [
        { name: 'RowNumber', index: 'RowNumber', width: 50, align: "center" },
