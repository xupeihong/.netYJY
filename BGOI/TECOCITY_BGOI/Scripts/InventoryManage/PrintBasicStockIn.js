        ...
        success: function (data) {
            ...
            if (json.length > 0) {
                for (var i = 0; i < json.length; i++) {
                    ...
                    //html += '<td style="width: 2%;">' + ((str[len - 9] != undefined) ? str[len - 9] : "") + '</td>';
                    //html += '<td style="width: 2%;">' + ((str[len - 8] != undefined) ? str[len - 8] : "") + '</td>';
                    //html += '<td style="width: 2%;">' + ((str[len - 7] != undefined) ? str[len - 7] : "") + '</td>';
                    //html += '<td style="width: 2%;">' + ((str[len - 6] != undefined) ? str[len - 6] : "") + '</td>';
                    //html += '<td style="width: 2%;">' + ((str[len - 5] != undefined) ? str[len - 5] : "") + '</td>';
                    //html += '<td style="width: 2%;">' + ((str[len - 4] != undefined) ? str[len - 4] : "") + '</td>';
                    //html += '<td style="width: 2%;">' + ((str[len - 3] != undefined) ? str[len - 3] : "") + '</td>';
                    //html += '<td style="width: 2%;">' + ((str[len - 2] != undefined) ? str[len - 2] : "") + '</td>';
                    //html += '<td style="width: 2%;">' + ((str[len - 1] != undefined) ? str[len - 1] : "") + '</td>';
