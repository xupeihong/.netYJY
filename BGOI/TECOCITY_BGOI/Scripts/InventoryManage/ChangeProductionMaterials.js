...
$(document).ready(function () {
    ...
    $("#btnSave").click(function () {
        ...
        if (ids == null) {
            ...
            var LLID = Model.LLID;
            window.parent.addProDetail(LLID);
...
function reload() {
    $("#list").jqGrid('setGridParam', {
        url: 'ProductionMaterialsOutSalesList',
        datatype: 'json',
...
function jq() {
    jQuery("#list").jqGrid({
        ...
        colNames: ['序号', '领料单编号', '创建时间', '创建人'],
        colModel: [
        { name: 'RowNumber', index: 'RowNumber', width: 50, align: "center" },
        { name: 'LLID', index: 'LLID', width: 150, align: "center" },
        ...
        //{ name: 'OrderUnit', inddex: 'OrderUnit', width: 120, align: "center" },
        ...
        { name: 'CreateUser', index: 'CreateUser', width: 150, align: "center" }
