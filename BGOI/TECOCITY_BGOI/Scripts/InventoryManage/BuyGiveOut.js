...
$(document).ready(function () {
    ...
    $("#btnPrint").click(function () {
        ...
        if (rowid == null) {
            ...
            var url = "PrintBuyGiveOut?Info=" + escape(texts);
...
function AddBuyGiveOut() {
    ...
    window.parent.parent.OpenDialog("新增出库单", "../InventoryManage/AddBuyGiveOut", 800, 450);
...
function jq() {
    ...
    jQuery("#list").jqGrid({
        ...
        colNames: ['','序号', '出库单号', '科目', '出库时间', '经手人', '总金额', '所属仓库', '备注', '内购人', '状态'],
        colModel: [
        ...
        { name: 'Purchase', index: 'Purchase', width: 80, align: "center" },
...
function jq1(ListOutID) {
    ...
    jQuery("#list1").jqGrid({
        ...
        colNames: ['序号', '产品编号', '产品名称', '规格型号', '单位', '申请数量','实际数量', '单价', '厂家','批号', '备注','内购编号'],
        colModel: [
        { name: 'RowNumber', index: 'RowNumber', width: 50, align: "center" },
