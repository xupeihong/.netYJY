        ...
        success: function (data) {
            ...
            if (json.length > 0) {
                for (var i = 0; i < json.length; i++) {
                    ...
                    html += '<td style="width: 80px;">' + json[i].StockOutCount + '</td>';
                    ...
                    html += '<td colspan="3" style="width: 150px;">' + json[i].Remark + '</td>';
                    html += '</tr>'
                    ...
                    //html += '<td ><lable class="labStockOutCount' + rowCount + '  id="StockOutCount' + rowCount + '">' + json[i].StockOutCount + '</lable></td>';
                    //html += '<td ><lable class="labStockOutCountActual' + rowCount + '  id="StockOutCountActual' + rowCount + '">' + json[i].StockOutCountActual + '</lable></td>';
