...
$(document).ready(function () {
    ...
    $("#btnPrint").click(function () {
        ...
        if (rowid == null) {
            ...
            var url = "PrintBasicOutList?Info=" + escape(texts)+"&type=0";
...
function AddBuyGiveOut() {
    ...
    window.parent.parent.OpenDialog("新增基本出库单", "../InventoryManage/AddBasicStockOut", 800, 450);

}

function jq() {
    var ListOutID = $('#ListOutIDold').val();
    ...
    jQuery("#list").jqGrid({
        ...
        colNames: ['','序号', '出库单编号', '出库时间', '经手人', '总金额', '所属仓库', '备注', '状态'],
        colModel: [
...
function jq1(ListOutID) {
    ...
    jQuery("#list1").jqGrid({
        ...
        colNames: ['序号', '产品编号', '产品名称', '规格型号', '单位', '申请数量', '实际数量', '单价', '厂家', '批号', '备注'],
        colModel: [
        { name: 'RowNumber', index: 'RowNumber', width: 50, align: "center" },
...
function returnConfirm() {
    ...
    $("#ListOutID").val($("#ListOutIDnew").val());
    // var str = "";
