...
function jq() {
    ...
    jQuery("#list").jqGrid({
        ...
        colNames: ['序号', '产品编号', '物料编码', '货品名称', '规格型号',  '单位','数量', '单价', '总金额', '创建时间', 'DID'],
        colModel: [
        { name: 'RowNumber', index: 'RowNumber', width: 50, align: "center" },
        { name: 'SIID', index: 'SIID', width: 150, align: "center" },
        ...
        { name: 'Company', inddex: 'Company',width:120,align:"center" },
