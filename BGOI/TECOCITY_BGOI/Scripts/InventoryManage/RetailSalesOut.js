...
$(document).ready(function () {
    ...
    $("#btnPrint").click(function () {
        ...
        if (rowid == null) {
            ...
            var url = "PrintBasicOutList?Info=" + escape(texts);
...
function AddRetailSalesOut() {
    ...
    window.parent.parent.OpenDialog("新增出库单", "../InventoryManage/AddRetailSalesOut", 800, 450);
...
function jq() {
    ...
    jQuery("#list").jqGrid({
        ...
        colNames: ['','序号', '出库单号',  '出库时间', '库管','经手人', '总金额', '所属仓库','备注', '状态'],
        colModel: [
