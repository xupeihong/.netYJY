...
function AddBuyGiveOut() {
    window.parent.parent.OpenDialog("新增出库单", "../InventoryManage/AddBasicStockOut", 800, 450);
}
...
function jq() {
    ...
    jQuery("#list").jqGrid({
        url: 'StorageManagementOutList',
        datatype: 'json',
        postData: { curpage: curPage, rownum: OnePageCount, ListOutID: ListOutID, HouseID: HouseID, Begin: Begin, End: End, State: State, ProType: ProType },
        loadonce: false,
        mtype: 'POST',
        jsonReader: {
            root: function (obj) {
        ...
        colNames: ['','序号', '出库单编号', '科目', '出库时间', '经办人', '总金额', '所属仓库','货品库类型', '状态'],
        colModel: [
