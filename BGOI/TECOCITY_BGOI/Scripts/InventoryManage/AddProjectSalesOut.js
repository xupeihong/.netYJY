...
$(document).ready(function () {
    ...
    $("#btnSave").click(function () {
        ...
        $.ajax({
            url: "SaveOrderProSalesOut",
            type: "Post",
            data: {
                ListOutID: ListOutID, SubjectID: SubjectID, ProOutTime: ProOutTime, HouseID: HouseID, DID: DID, Use: Use,Count:Count,Remark1:Remark1,Purchase:Purchase,
...
function AddNewOut() {
    ShowIframe1("选择项目销售货品", "../InventoryManage/ChangeProjectSales", 500, 350);
}
function GetAmount() {
    $("#AmountM").val("");
    var Amount = 0;
