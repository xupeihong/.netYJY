...
$(document).ready(function () {
    ...
    $("#btnPrint").click(function () {
        ...
        if (rowid == null) {
            ...
            var url = "PrintSecondOut?Info=" + escape(texts);
...
function AddBuyGiveOut() {
    ...
    window.parent.parent.OpenDialog("新增二级出库单", "../InventoryManage/AddSecondOut", 800, 450);
...
function jq() {
    ...
    jQuery("#list").jqGrid({
        ...
        colNames: ['','序号', '出库单编号', '科目', '出库时间', '经手人', '总金额', '所属仓库', '备注','状态'],
        colModel: [
...
function jq1(ListOutID) {
    ...
    jQuery("#list1").jqGrid({
        ...
        loadComplete: function () {
            $("#list1").jqGrid("setGridHeight", $("#pageContent").height() / 2 - 140, false);
