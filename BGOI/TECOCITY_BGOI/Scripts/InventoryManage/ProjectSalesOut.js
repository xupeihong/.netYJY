...
$(document).ready(function () {
    ...
    $("#btnPrint").click(function () {
        ...
        if (rowid == null) {
            ...
            var url = "PrintProjectSalesOut?Info=" + escape(texts);
...
function AddProjectSalesOut() {

    window.parent.parent.OpenDialog("新增出库单", "../InventoryManage/AddProjectSalesOut", 800, 450);
...
function jq() {
    ...
    jQuery("#list").jqGrid({
        ...
        colNames: ['','序号', '出库单号',  '出库时间', '经手人', '总金额', '所属仓库', '状态'],
        colModel: [
...
function jq1(ListOutID) {
    ...
    jQuery("#list1").jqGrid({
        ...
        colNames: ['序号', '物品编号', '物品名称', '规格型号', '单位', '申请数量','实际数量','单价', '厂家','批号', '备注','订单号'],
        colModel: [
        { name: 'RowNumber', index: 'RowNumber', width: 50, align: "center" },
