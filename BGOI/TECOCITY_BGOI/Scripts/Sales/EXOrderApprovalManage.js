...
$(document).ready(function () {
    ...
    $('#EXSP').click(function () {
        ...
        if (rowid == null) {
            ...
            $.ajax({
                url: "../SalesManage/ExJudgeAppDisable",
                type: "post",
    ...
    $("#SHowEXOrderXX").click(function () {
        ...
        window.parent.OpenDialog("审批报价详细", "../SalesManage/SHowEXOrderXX?id=" + texts, 1000, 550, '');
...
function jq() {
    ...
    jQuery("#list").jqGrid({
        ...
        colNames: ['', '订单编号号', '合同编号', '签订日期', '订货单位', '订货人', '退货审批', '合计', 'EXState','审批编号', ''],
        colModel: [
        ...
        { name: 'OrderContactor', index: 'OrderContactor', width: 150 },
         { name: 'EXStateDesc', index: 'EXStateDesc', width: 150 },
         { name: 'TotalTax', index: 'TotalTax', width: 150 },
           { name: 'EXState', index: 'EXState', width: 150, hidden: true },
