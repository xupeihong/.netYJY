...
$(document).ready(function () {
    ...
    $('#HKdiv').click(function () {
        ...
        $('#SPQKDIV').attr("class", "btnTh");
        $("#CCashBack").css("display", "");
        $("#UserLog").css("display", "none");
        $("#SPQK").css("display", "none");
        reload1();
    })
    ...
    $('#BGHT').click(function () {
        ...
        var texts = jQuery("#list").jqGrid('getRowData', rowid).CID;
        window.parent.OpenDialog("变更合同", "../Contract/ChangeContract?id=" + texts, 800, 600, '');
    })
    ...
    $('#HKJL').click(function () {
        ...
        var texts = jQuery("#list").jqGrid('getRowData', rowid).CID;
        window.parent.OpenDialog("回款记录", "../Contract/CashBack?id=" + texts, 800, 600, '');
    })
    ...
    $('#CKXX').click(function () {
        ...
        var texts = jQuery("#list").jqGrid('getRowData', rowid).CID;
        window.parent.OpenDialog("合同详细", "../Contract/DetailContract?id=" + texts, 800, 450, '');
    })

    $("#TJSP").click(function () {
        var rowid = $("#list").jqGrid('getGridParam', 'selrow');
        if (rowid == null) {
            alert("您还没有选择要提交审批的合同");
            return;
        }
        var texts = jQuery("#list").jqGrid('getRowData', rowid).CID + "@" + "销售合同审批";

       // var texts = ID + "@" + "备案审批";
        window.parent.OpenDialog("提交审批", "../SalesManage/SubmitApproval?id=" + texts, 700, 500, '');
      //  window.parent.OpenDialog("合同提交审批", "../Contract/SubmitApproval?id=" + texts, 800, 450, '');
    });
    $("#HTSP").click(function () {
       ...
       // var texts = jQuery("#list").jqGrid('getRowData', rowid).CID + "@" + "提交审批";

        //
        //var texts = ID + "@" + "备案审批";
       // window.parent.OpenDialog("提交审批", "../COM_Approval/SubmitApproval?id=" + texts, 700, 500, '');
        //
       // window.parent.OpenDialog("合同审批", "../Contract/DetailContract?id=" + texts, 800, 450, '');
    });
})
function reload() {
