        ...
        success: function (data) {
            ...
            if (json.length > 0) {
                ...
                for (var i = 0; i < json.length; i++) {
                    ...
                    html += '<td ><input type="text"  style="width:90px;" class="labProductID' + rowCount + ' " id="ProductID' + rowCount + '"value="' + json[i].ProductID + '"/></td>';
                    ...
                    html += '<td ><input type="text" class="labUnits' + rowCount + ' " style="width:90px;" id="Units' + rowCount + '" value="' + json[i].OrderUnit + '"/> </td>';
                    html += '<td ><input type="text" onchange=ChangeP()  onblur=XJ(this) id="Amount' + rowCount + '" style="width:90px;" value="' + json[i].OrderNum + '"/></td>';
                    html += '<td ><input type="text" style="width:90px;" readonly="readonly"  id="Supplier' + rowCount + '" value="' + json[i].Manufacturer + '"  style="width:90px;" /> </td>';
                    ...
                    html += '<td ><input type="text" style="width:90px;" id="Technology' + rowCount + '" onchange=ChangeP() value="' + json[i].Technology + '"  /> </td>';
...
function FDetail() {
    ...
    html += '<td ><input type="text" class="labProductID' + rowCount + ' " id="ProductID' + rowCount + '"  style="width:90px;" /></td>';
    html += '<td ><input type="text"  class="labProName' + rowCount + ' " id="ProName' + rowCount + '"  style="width:90px;"/></td>';
    html += '<td ><input type="text"  class="labSpec' + rowCount + ' " id="Spec' + rowCount + '"  style="width:90px; "/></td>';
    html += '<td ><input type="text"  class="labUnits' + rowCount + ' " id="Units' + rowCount + '"  style="width:90px;"/> </td>';
    html += '<td ><input type="text"  onblur=XJ(this)  id="Amount' + rowCount + '"  style="width:90px;" /></td>';
    html += '<td ><input type="text"    id="Supplier' + rowCount + '"  style="width:90px;"/> </td>';
    ...
    html += '<td ><input type="text"  id="TotalCost' + rowCount + '" readonly="readonly" style="width:90px;"/></td>';//累计成本';
        ...
        success: function (data) {
            ...
            if (json.length > 0) {
                ...
                for (var i = 0; i < json.length; i++) {
                    ...
                    html += '<td ><input class="labProName' + rowCount + ' " id="ProName' + rowCount + '" value="' + json[i].ProName + '" style="width:60px;" /> </td>';
                    html += '<td ><input class="labSpec' + rowCount + '" id="Spec' + rowCount + '"value="' + json[i].Spec + '" style="width:30px;" /> </td>';
                    html += '<td ><input class="labUnits' + rowCount + ' " id="Units' + rowCount + '"value="' + json[i].Units + '" style="width:30px;"  /> </td>';
                    html += '<td ><input type="text" onblur=XJ(this) id="Amount' + rowCount + '" style="width:20px;"/></td>';
                    html += '<td ><input type="text" onclick=CheckSupplier(this) style="width:30px;" readonly="readonly"  id="Supplier' + rowCount + '" /> </td>';
                    html += '<td ><input type="text" style="width:60px;"  onblur=XJ(this) id="UnitPrice' + rowCount + '" /> </td>';
                    html += '<td ><input type="text" style="width:60px;" readonly="readonly" id="Subtotal' + rowCount + '" /> </td>';
                    html += '<td ><input type="text"  id="UnitCost' + rowCount + '" onblur=TotalCost(this) style="width:30px;" /></td>';//单位成本';
                    html += '<td ><input type="text"  readonly="readonly"  id="TotalCost' + rowCount + '" style="width:60px;" /></td>';//累计成本';
...
function SaveUpdateOrderInfo() {
    ...
    $.ajax({
        ...
        data: {
            ...
            UseUnit: UseUnit, UseContactor: UseContactor, UseTel: UseTel, UseAddress: UseAddress, OrderActualTotal: OrderActualTotal, PayWay: PayWay, Guarantee: Guarantee,DeliveryTime:DeliveryTime,ExpectedReturnDate:ExpectedReturnDate,
            Provider: Provider, ProvidManager: ProvidManager, Demand: Demand, DemandManager: DemandManager, Remark: Remark,ChannelsFrom:ChannelsFrom,
