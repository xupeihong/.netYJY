...
function reload() {
    if ($('.field-validation-error').length == 0) {
        ...
        $("#list").jqGrid('setGridParam', {
            url: 'SearchApprovalRetail',
            datatype: 'json',
            postData: { curpage: curPage, rownum: OnePageCount, SalesProduct: SalesProduct, SpecsModels: SpecsModels, SalesMan: SalesMan, StartDate: StartDate, EndDate: EndDate, IsHK: IsHK },
...
function jq() {
    ...
    jQuery("#list").jqGrid({
        ...
        colNames: ['', '销售编号', '销售产品', '销售负责人', '任务状态', 'State', '审批编号'],
        colModel: [
