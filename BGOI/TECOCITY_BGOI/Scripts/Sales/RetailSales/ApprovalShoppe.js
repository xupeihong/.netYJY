...
function reload() {
    if ($('.field-validation-error').length == 0) {
        ...
        $("#list").jqGrid('setGridParam', {
            url: 'SearchApprovalShoppe',
            datatype: 'json',
            postData: { curpage: curPage, rownum: OnePageCount, SIID: SIID, Customer: Customer, StartDate: StartDate, EndDate: EndDate },
...
function jq() {
    ...
    jQuery("#list").jqGrid({
        ...
        { name: 'SIID', index: 'SIID', width: 150 },
        { name: 'Customer', index: 'Customer', width: $("#bor").width() - 700 },
