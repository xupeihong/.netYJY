    ...
    if ($('.field-validation-error').length == 0) {
       ...
       // ISCollection = $("input[name='ISCollection']:checked").val();
        ...
        $("#list").jqGrid('setGridParam', {
            url: 'GetSalesGrid',
            datatype: 'json',
            postData: { curpage: curPage, rownum: OnePageCount, SalesProduct: SalesProduct, SpecsModels: SpecsModels, SalesMan: SalesMan, StartDate: StartDate, EndDate: EndDate, IsHK: IsHK, State: State, OrderContactor: OrderContactor, OrderTel: OrderTel, ISCollection: ISCollection },
...
function LoadBasInfo() {
    ...
    jQuery("#list").jqGrid({
        url: 'GetSalesGrid',
        datatype: 'json',
        postData: { curpage: curPage, rownum: OnePageCount, SalesProduct: SalesProduct, SpecsModels: SpecsModels, SalesMan: SalesMan, StartDate: StartDate, EndDate: EndDate, IsHK: IsHK, State: State, OrderContactor: OrderContactor, OrderTel: OrderTel },
        loadonce: false,
        mtype: 'POST',
        jsonReader: {
            root: function (obj) {
        ...
        colNames: ['项目编号', '销售时间', '项目名称', '产品名称', '数量', '规格型号', '成本单价', '金额小计', '款项情况', '销售日期', '最终安装地址', '客户名称', '客户电话', '安装单位', '备注', '是否回款', '所属单位', '业务负责人'],
        colModel: [
        { name: 'OrderID', index: 'OrderID', width: 140, align: 'center', hidden: true },
        { name: 'ContractDate', index: 'ContractDate', width: 150, align: 'center' },
        { name: 'ProjectName', index: 'ProjectName', width: 150, align: 'center', hidden: true },
        { name: 'OrderContent', index: 'OrderContent', width: 200, align: 'center' },
        { name: 'OrderNum', index: 'OrderNum', width: 90, align: 'center', hidden: true },
        { name: 'SpecsModels', index: 'SpecsModels', width: 150, align: 'center', hidden: true },
        { name: 'UnitPrice', index: 'UnitPrice', width: 150, align: 'center', hidden: true },
        { name: 'DTotalPrice', index: 'DTotalPrice', width: 150, align: 'center', hidden: true },
        { name: 'ProductRemark', index: 'ProductRemark', width: 200, align: 'center', hidden: true },
        ...
        { name: 'IsHK', index: 'IsHK', width: 150 },
...
function LoadDetail(orderID) {
    ...
    jQuery("#loadlist").jqGrid({
        url: 'GetDetailGrid',
        datatype: 'json',
        postData: { OrderID: orderID, curpage: DcurPage, rownum: OnePageCount },
        loadonce: false,
        mtype: 'POST',
        jsonReader: {
            root: function (obj) {
