$(document).ready(function () {
    ...
    $("#ISEXc").click(function () {
        // Checkbol = document.getElementById('cb').checked
        ...
        if (isConfirm == false) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    ContractID:ContractID,ISF:ISF,ISEXR:ISEXR,
                    //换货信息
        ...
        success: function (data) {
            ...
            if (json.length > 0) {
                ...
                for (var i = 0; i < json.length; i++) {
                    ...
                    html += '<td ><lable style="width:60px;" class="labRowNumber' + rowCount + ' "  id="RowNumber' + rowCount + '">' + CountRows + '</lable></td>';
                    html += '<td ><lable style="width:90px;" class="labProductID' + rowCount + ' " id="RProductID' + rowCount + '">' + json[i].ProductID + '</lable> </td>';
                    html += '<td ><lable class="labProName' + rowCount + ' " id="ROrderContent' + rowCount + '" style="width:90px;">' + json[i].ProName + '</lable></td>';
                    html += '<td ><lable  class="labSpec' + rowCount + ' " id="RSpec' + rowCount + '" style="width:90px;"  >' + json[i].Spec + '  </lable></td>';
                    html += '<td ><lable  class="labUnits' + rowCount + ' " id="RUnits' + rowCount + '"  style="width:90px;"  >' + json[i].Units + '</lable></td>';
                    html += '<td ><input type="text" onclick=CheckSupplier(this)   id="RSupplier' + rowCount + '" style="width:90px;" /> </td>';//readonly="readonly"
                    ...
                    html += '<td ><input type="text" readonly="readonly"  id="RTotalCost' + rowCount + '" style="width:90px;" /></td>';//累计成本';
