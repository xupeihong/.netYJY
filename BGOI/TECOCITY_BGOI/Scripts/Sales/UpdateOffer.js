        ...
        success: function (data) {
            ...
            if (json.length > 0) {
                ...
                for (var i = 0; i < json.length; i++) {
                    ...
                    html += '<td ><lable style="width:90px;" class="labSpecifications' + rowCount + '" id="Spec' + rowCount + '" >' + json[i].Spec + '</lable> </td>';
                    html += '<td ><lable class="labUnit' + rowCount + '" id="Units' + rowCount + '" style="width:90px;" >' + json[i].Units + '</lable> </td>';
                    html += '<td ><input type="text"  onblur=XJ(this)  id="Amount' + rowCount + '"  style="width:90px;" /></td>';
                    html += '<td ><input type="text" style="width:90px;"  id="Supplier' + rowCount + '" /> </td>';//onclick=CheckSupplier() 
                    html += '<td ><input type="text" style="width:90px;"  onblur=XJ(this) id="UnitPrice' + rowCount + '" /></td>';
                    html += '<td ><input type="text" style="width:90px;" readonly="readonly" id="txtTotal' + rowCount + '"  /> </td>';
                    //
        ...
        success: function (data) {
            ...
            if (json.length > 0) {
                ...
                for (var i = 0; i < json.length; i++) {
                    ...
                    html += '<td ><lable style="width:90px;" class="labOrderContent' + rowCount + '" id="ProName' + rowCount + '">' + json[i].OrderContent + '</lable> </td>';
                    html += '<td ><lable class="labSpecifications' + rowCount + '" style="width:90px;" id="Spec' + rowCount + '">' + json[i].Specifications + '</lable> </td>';
                    html += '<td ><lable class="labUnit' + rowCount + '"style="width:90px;" id="Units' + rowCount + '">' + json[i].Unit + '</lable> </td>';
                    html += '<td ><input type="text"  onblur=XJ(this)  id="Amount' + rowCount + '" value="' + json[i].Amount + '" style="width:90px;"/></td>';
                    html += '<td ><input type="text" style="width:90px;"   id="Supplier' + rowCount + '" value="' + json[i].Supplier + '"> </td>';//onclick=CheckSupplier()
...
function UpdateOffer() {
    ...
    $.ajax({
        ...
        type: "Post",
        data: {
            PID: PID, BJID: BJID, OfferTitle: OfferTitle, OfferTime: OfferTime, FKYD: FKYD, Description: Description,Customer:Customer,CustomerTel:CustomerTel,
