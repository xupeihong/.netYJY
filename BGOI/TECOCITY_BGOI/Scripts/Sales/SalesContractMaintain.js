...
$(document).ready(function () {
    ...
    $('#XZHT').click(function () {
        window.parent.OpenDialog("新增合同", "../SalesManage/AddContract", 800, 600, '');
    })
    ...
    $('#GLWJ').click(function () {
        ...
        window.parent.OpenDialog("管理文件", "../SalesManage/AddFile?id=" + texts, 500, 300, '');
    })
    ...
    $('#BGHT').click(function () {
        ...
        var texts = jQuery("#list").jqGrid('getRowData', rowid).CID;
        window.parent.OpenDialog("变更合同", "../SalesManage/ChangeContract?id=" + texts, 800, 600, '');
    })
    ...
    $('#HKJL').click(function () {
        ...
        var texts = jQuery("#list").jqGrid('getRowData', rowid).CID;
        window.parent.OpenDialog("回款记录", "../SalesManage/CashBack?id=" + texts, 800, 600, '');
    })
    ...
    $('#HTJS').click(function () {
        ...
        var texts = jQuery("#list").jqGrid('getRowData', rowid).CID;
        window.parent.OpenDialog("合同结算", "../SalesManage/Settlement?id=" + texts, 800, 400, '');
    })
    ...
    $('#CKXX').click(function () {
        ...
        var texts = jQuery("#list").jqGrid('getRowData', rowid).CID;
        window.parent.OpenDialog("合同详细", "../SalesManage/DetailContract?id=" + texts, 800, 450, '');
    })
    ...
    $('#XZDD').click(function () {
        ...
        var texts = jQuery("#list").jqGrid('getRowData', rowid).CID;
        window.parent.OpenDialog("合同新增订单", "../SalesManage/AddContractOrder?id=" + texts, 1000, 450, '');
...
function updateCB(id) {
    window.parent.OpenDialog("修改回款记录", "../SalesManage/UpdateCashBack?id=" + id, 800, 600, '');
}
