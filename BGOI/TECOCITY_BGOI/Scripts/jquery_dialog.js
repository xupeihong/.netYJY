...
function ShowIframe1(title, contentUrl, width, height, event)
{
...
Popup.prototype={
    ...
    build:function(){
        ...
        var close = '<a id="dialogBoxClose" title="关闭" style="padding:0;font-weight:bold;color:#ffffff;cursor:pointer;font-size:14px;font-family:Airal;">X</a>';
