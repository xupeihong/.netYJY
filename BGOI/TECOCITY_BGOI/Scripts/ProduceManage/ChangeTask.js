...
$(document).ready(function () {
    ...
    $("#btnSave").click(function () {
        ...
        if (rowid.length == 0) {
            ...
            window.parent.addTaskDetail(PID, OrderID, ContractID);
            window.parent.custom(OrderID);
...
function reload() {
    ...
    $("#list").jqGrid('setGridParam', {
        ...
        datatype: 'json',
        postData: { curpage: curPage, rownum: OnePageCount, OrderID: OrderID, SpecsModels: SpecsModels },
