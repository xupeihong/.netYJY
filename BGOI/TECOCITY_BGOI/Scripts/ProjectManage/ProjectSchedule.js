...
$(document).ready(function () {
    ...
    $('#XG').click(function () {
        ...
        if (rowid == null) {
            ...
            var texts = jQuery("#list").jqGrid('getRowData', rowid).ID + "@" + jQuery("#list").jqGrid('getRowData', rowid).Pname;
            window.parent.OpenDialog("过程记录修改", "../ProjectManage/UpdateSchedule?id=" + texts, 600, 400, '');
        }
    })
...
function jq() {
    ...
    jQuery("#list").jqGrid({
        ...
        colNames: ['', '项目编号', 'PID', '内部编号', '项目名称', '立项时间', '项目负责人', 'ID', '过程记录概述', '过程记录时间', '所属单位'],
        colModel: [
        ...
        { name: 'Pview', index: 'Pview', width: $("#bor").width() - 900 },
        { name: 'ctime', index: 'ctime', width: 150 },
