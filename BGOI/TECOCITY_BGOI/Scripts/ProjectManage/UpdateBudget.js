...
$(document).ready(function () {
    ...
    loadFile();
    $("#uploadify").uploadify({
        uploader: 'InsertBudgetFile',           // 服务器端处理地址
        ...
        formData: { 'PID': $("#StrPID").val(), 'sid': $("#Strbid").val() },// 'Types': $("#StrType").val(), 'Comments': $("#StrComments").val()
        // 两个配套使用
...
function loadFile() {
    ...
    var InforNo = document.getElementById("Strbid").value;
    $.ajax({
        url: "GetBudgetFile",
        type: "post",
        data: { data1: InforNo },
