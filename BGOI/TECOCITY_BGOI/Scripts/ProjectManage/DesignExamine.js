...
$(document).ready(function () {
    ...
    $('#SP').click(function () {
        ...
        if (rowid == null) {
            ...
            var PID = jQuery("#list").jqGrid('getRowData', rowid).sid;
...
function jq() {
    ...
    jQuery("#list").jqGrid({
        ...
        colNames: ['', '项目编号', 'PID', '内部编号', '设计编号', 'sid', '项目名称', '项目负责人', '立项时间', '项目状态', 'State', '审批编号', '所属单位'],
        colModel: [
        ...
        { name: 'sidShow', index: 'sidShow', width: 150 },
        { name: 'sid', index: 'sid', width: 130, hidden: true },
