...
$(document).ready(function () {
    ...
    $('#XG').click(function () {
        ...
        if (rowid == null) {
            ...
            window.parent.OpenDialog("项目结项修改", "../ProjectManage/UpdateProFinish?id=" + texts, 700, 570, '');
        }
    })
...
function jq() {
    ...
    jQuery("#list").jqGrid({
        ...
        colNames: ['', '项目编号', 'PID', '内部编号', '项目名称', '立项时间', '项目负责人', '结项日期', '是否欠款', '欠款金额', '欠款原因', '备注', '所属单位'],
        colModel: [
        ...
        { name: 'FinishDate', index: 'FinishDate', width: 130 },
        { name: 'IsDebt', index: 'IsDebt', width: 100 },
        { name: 'DebtAmount', index: 'DebtAmount', width: 100 },
        { name: 'DebtReason', index: 'DebtReason', width: $("#bor").width() - 800 },
