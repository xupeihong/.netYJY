...
$(document).ready(function () {
    ...
    $('#SP').click(function () {
        ...
        if (rowid == null) {
            ...
            var PID = jQuery("#list").jqGrid('getRowData', rowid).bid;
...
function jq() {
    ...
    jQuery("#list").jqGrid({
        ...
        colNames: ['', '项目编号', 'PID', '内部编号', '预算编号', 'bid', '项目名称', '项目负责人', '立项时间', '项目状态', 'State', '审批编号', '所属单位'],
        colModel: [
        ...
        { name: 'bidShow', index: 'bidShow', width: 150 },
        { name: 'bid', index: 'bid', width: 130, hidden: true },
        ...
        gridComplete: function () {
            ...
            for (var i = 0; i < ids.length; i++) {
                ...
                var str1 = "<a href='#' style='color:blue' onclick='ShowBudget(\"" + curRowData.bidShow + "\")' >" + curRowData.bidShow + "</a>";

                jQuery("#list").jqGrid('setRowData', ids[i], { bidShow: str1 });
...
function select(rowid) {
    ...
    RelenvceID = jQuery("#list").jqGrid('getRowData', rowid).bid;
    reload1();
    reload2();
}
