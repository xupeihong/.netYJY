...
$(document).ready(function () {
    ...
    $('#SP').click(function () {
        ...
        if (rowid == null) {
            ...
            var PID = jQuery("#list").jqGrid('getRowData', rowid).PcID;
...
function jq() {
    ...
    jQuery("#list").jqGrid({
        ...
        colNames: ['', '项目编号', 'PID', '内部编号', 'PcID', '合同编号', '项目名称', '项目负责人', '立项时间', '项目状态', 'State', '审批编号', '所属单位'],
        colModel: [
        ...
        { name: 'PcID', index: 'PcID', width: 130, hidden: true },
        { name: 'PcNum', index: 'PcNum', width: 130 },
...
function select(rowid) {
    ...
    RelenvceID = jQuery("#list").jqGrid('getRowData', rowid).PcID;
    reload1();
    reload2();
}
