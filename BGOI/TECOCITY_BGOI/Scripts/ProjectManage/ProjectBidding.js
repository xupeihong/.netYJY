...
$(document).ready(function () {
    ...
    $('#XG').click(function () {
        ...
        if (rowid == null) {
            ...
            var texts = jQuery("#list").jqGrid('getRowData', rowid).BidID + "@" + jQuery("#list").jqGrid('getRowData', rowid).Pname;
            window.parent.OpenDialog("项目投标修改", "../ProjectManage/UpdateBidding?id=" + texts, 600, 400, '');
        }
    })
    ...
    $('#CX').click(function () {
        ...
        if (rowid == null) {
            ...
            var texts = jQuery("#list").jqGrid('getRowData', rowid).BidID;
    ...
    $('#XZ').click(function () {
        ...
        if (rowid == null) {
            ...
            var texts = jQuery("#list").jqGrid('getRowData', rowid).BidID;
            window.parent.OpenDialog("投标文档下载", "../ProjectManage/DownLoadBidding?id=" + texts, 400, 200, '');
        }
    })
    ...
    $('#TJSP').click(function () {
        ...
        if (rowid == null) {
            ...
            var texts = jQuery("#list").jqGrid('getRowData', rowid).BidID + "@" + "投标审批";
...
function jq() {
    ...
    jQuery("#list").jqGrid({
        ...
        colNames: ['', '项目编号', 'PID', '内部编号', '项目名称', '立项时间', '项目负责人', '投标编号', '投标时间', '概述', '所属单位', '状态', 'state'],
        colModel: [
        ...
        { name: 'BiddingTime', index: 'BiddingTime', width: 70 },
