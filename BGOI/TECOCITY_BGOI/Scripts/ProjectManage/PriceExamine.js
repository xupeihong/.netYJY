...
$(document).ready(function () {
    ...
    $('#SP').click(function () {
        ...
        if (rowid == null) {
            ...
            var PID = jQuery("#list").jqGrid('getRowData', rowid).oid;
...
function jq() {
    ...
    jQuery("#list").jqGrid({
        ...
        colNames: ['', '项目编号', 'PID', '内部编号', '报价编号', 'oid', '项目名称', '项目负责人', '立项时间', '项目状态', 'State', '审批编号', '所属单位'],
        colModel: [
        ...
        { name: 'oidShow', index: 'oidShow', width: 150 },
        { name: 'oid', index: 'oid', width: 130, hidden: true },
        ...
        gridComplete: function () {
            ...
            for (var i = 0; i < ids.length; i++) {
                ...
                var str1 = "<a href='#' style='color:blue' onclick='ShowPrice(\"" + curRowData.oidShow + "\")' >" + curRowData.oidShow + "</a>";

                jQuery("#list").jqGrid('setRowData', ids[i], { oidShow: str1 });
...
function select(rowid) {
    ...
    RelenvceID = jQuery("#list").jqGrid('getRowData', rowid).oid;
    reload1();
    reload2();
}
