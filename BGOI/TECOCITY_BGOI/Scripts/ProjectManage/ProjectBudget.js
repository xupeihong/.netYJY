...
$(document).ready(function () {
    ...
    $('#XG').click(function () {
        ...
        if (rowid == null) {
            ...
            var texts = jQuery("#list").jqGrid('getRowData', rowid).bid + "@" + jQuery("#list").jqGrid('getRowData', rowid).Pname;
            window.parent.OpenDialog("预算修改", "../ProjectManage/UpdateBudget?id=" + texts, 600, 400, '');
        }
    })
    ...
    $('#CX').click(function () {
        ...
        if (rowid == null) {
            ...
            var texts = jQuery("#list").jqGrid('getRowData', rowid).bid;
    ...
    $('#XZ').click(function () {
        ...
        if (rowid == null) {
            ...
            var texts = jQuery("#list").jqGrid('getRowData', rowid).bid;
            window.parent.OpenDialog("预算文档下载", "../ProjectManage/DownLoadBudget?id=" + texts, 400, 200, '');
        }
    })
    ...
    $('#TJSP').click(function () {
        ...
        if (rowid == null) {
            ...
            var texts = jQuery("#list").jqGrid('getRowData', rowid).bid + "@" + "预算审批";
...
function jq() {
    ...
    jQuery("#list").jqGrid({
        ...
        colNames: ['', '项目编号', 'PID', '内部编号', '项目名称', '立项时间', '项目负责人', '预算编号', '概述', '所属单位', '状态', 'state'],
        colModel: [
