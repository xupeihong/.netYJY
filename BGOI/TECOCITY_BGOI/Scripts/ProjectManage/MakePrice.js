...
$(document).ready(function () {
    ...
    $('#XG').click(function () {
        ...
        if (rowid == null) {
            ...
            var texts = jQuery("#list").jqGrid('getRowData', rowid).oid + "@" + jQuery("#list").jqGrid('getRowData', rowid).Pname;
            window.parent.OpenDialog("项目报价修改", "../ProjectManage/UpdatePrice?id=" + texts, 600, 400, '');
        }
    })
    ...
    $('#CX').click(function () {
        ...
        if (rowid == null) {
            ...
            var texts = jQuery("#list").jqGrid('getRowData', rowid).oid;
    ...
    $('#XZ').click(function () {
        ...
        if (rowid == null) {
            ...
            var texts = jQuery("#list").jqGrid('getRowData', rowid).oid;
            window.parent.OpenDialog("报价文档下载", "../ProjectManage/DownLoadPrice?id=" + texts, 400, 200, '');
        }
    })
    ...
    $('#TJSP').click(function () {
        ...
        if (rowid == null) {
            ...
            var texts = jQuery("#list").jqGrid('getRowData', rowid).oid + "@" + "项目报价审批";
...
function jq() {
    ...
    jQuery("#list").jqGrid({
        ...
        colNames: ['', '项目编号', 'PID', '内部编号', '项目名称', '立项时间', '项目负责人', '报价编号', '概述','报价总额', '所属单位', '状态', 'state'],
        colModel: [
        ...
        { name: 'Pview', index: 'Pview', width: $("#bor").width() - 850 },
        { name: 'PriceAmount', index: 'PriceAmount', width: 70 },
