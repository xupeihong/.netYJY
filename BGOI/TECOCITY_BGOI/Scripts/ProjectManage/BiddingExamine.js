...
$(document).ready(function () {
    ...
    $('#SP').click(function () {
        ...
        if (rowid == null) {
            ...
            var PID = jQuery("#list").jqGrid('getRowData', rowid).BidID;
...
function jq() {
    ...
    jQuery("#list").jqGrid({
        ...
        colNames: ['', '项目编号', 'PID', '内部编号', '投标编号', 'bid', '项目名称', '项目负责人', '立项时间', '项目状态', 'State', '审批编号'],
        colModel: [
        ...
        { name: 'BidIDShow', index: 'BidIDShow', width: 150 },
        { name: 'BidID', index: 'BidID', width: 130, hidden: true },
        ...
        { name: 'SPID', index: 'SPID', width: 150 }
        ],
        pager: jQuery('#pager'),
        pgbuttons: true,
        rowNum: OnePageCount,
        ...
        gridComplete: function () {
            ...
            for (var i = 0; i < ids.length; i++) {
                ...
                var str1 = "<a href='#' style='color:blue' onclick='ShowBidding(\"" + curRowData.BidIDShow + "\")' >" + curRowData.BidIDShow + "</a>";

                jQuery("#list").jqGrid('setRowData', ids[i], { BidIDShow: str1 });
...
function select(rowid) {
    ...
    RelenvceID = jQuery("#list").jqGrid('getRowData', rowid).BidID;
    reload1();
    reload2();
}
