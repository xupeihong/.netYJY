...
$(document).ready(function () {
    ...
    $("#uploadify").uploadify({
        uploader: 'InsertPreDesignFile',           // 服务器端处理地址
        ...
        formData: { 'PID': $("#StrPID").val(), 'sid': $("#Strsid").val() },// 'Types': $("#StrType").val(), 'Comments': $("#StrComments").val()
        // 两个配套使用
...
function loadFile() {
    ...
    var InforNo = document.getElementById("Strsid").value;
    $.ajax({
        url: "GetFile",
        type: "post",
        data: { data1: InforNo },
