...
$(document).ready(function () {
    ...
    $('#SP').click(function () {
        ...
        if (rowid == null) {
            ...
            var PID = jQuery("#list").jqGrid('getRowData', rowid).EID;
...
function jq() {
    ...
    jQuery("#list").jqGrid({
        ...
        colNames: ['', '项目编号', 'PID', '内部编号', '分包施工编号', 'EID', '项目名称', '项目负责人', '立项时间', '项目状态', 'State', '审批编号', '所属单位'],
        colModel: [
        ...
        { name: 'EIDShow', index: 'EIDShow', width: 150 },
        { name: 'EID', index: 'EID', width: 130, hidden: true },
        ...
        gridComplete: function () {
            ...
            for (var i = 0; i < ids.length; i++) {
                ...
                var str1 = "<a href='#' style='color:blue' onclick='ShowSubWork(\"" + curRowData.EIDShow + "\")' >" + curRowData.EIDShow + "</a>";

                jQuery("#list").jqGrid('setRowData', ids[i], { EIDShow: str1 });
...
function select(rowid) {
    ...
    RelenvceID = jQuery("#list").jqGrid('getRowData', rowid).EID;
    reload1();
    reload2();
}
...
function jq2() {
    jQuery("#list2").jqGrid({
        ...
        colNames: ['', '分包施工编号', '操作内容', '操作结果', '操作时间', '操作人'],
        colModel: [
        { name: 'IDCheck', index: 'Id', width: 20, hidden: true },
