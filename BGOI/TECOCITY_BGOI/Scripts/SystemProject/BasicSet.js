...
$(document).ready(function () {
    ...
    $('#XZ').click(function () {
        ...
        window.parent.OpenDialog("新增内容", "../SystemProject/AddContent?id=" + sel, 400, 200, '');
    })
})
...
function UpdateType(xid, type, text) {
    window.parent.OpenDialog("修改内容", "../SystemProject/UpdateContent?id=" + xid + "@" + type + "@" + text, 400, 200);
}
