...
$(document).ready(function () {
    ...
    $("#btnSave").click(function () {
        ...
        //alert(1);
        $.ajax({
            url: "SaveUpHomeSalesInstallation",
            type: "Post",
            data: {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var i = 0; i < json.length; i++) {
                ...
                //html += '<td ><input type="text"  style="width:110px;" id="OrderContent' + rowCount + '" value=' + json[i].OrderContent + '\ /></td>';
                //html += '<td ><input type="text"  style="width:170px;" id="SpecsModels' + rowCount + '" value=' + json[i].SpecsModels + '\ /></td>';
                //html += '<td ><input type="text"  style="width:30px;" id="OrderUnit' + rowCount + '" value=' + json[i].Unit + ' \/></td>';
                ...
                html += '<td ><input type="text"  style="width:30px;" id="OrderNum' + rowCount + '" onblur="OnBlurAmount(this);" value=' + json[i].Num + ' \/></td>';
                html += '<td ><input type="text"  style="width:30px;" id="Price' + rowCount + '"  onblur="OnPriceTotal(this);" value=' + json[i].UnitPrice + '\ /></td>';
                html += '<td ><input type="text"  style="width:30px;" id="Subtotal' + rowCount + '" style="width:60px;" value=' + json[i].Total + '\ /></td>';
