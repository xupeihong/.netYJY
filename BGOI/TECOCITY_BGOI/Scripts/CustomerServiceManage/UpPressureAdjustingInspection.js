        ...
        success: function (data) {
            ...
            if (json.length > 0) {
                for (var i = 0; i < json.length; i++) {
                    ...
                    html += '<td  colspan="2">P1= <input type="text" value="' + json[i].UsePressureShangP1 + '" id="p1' + rowCount + '" style="width:30px;"/>MPa</td>';
                    html += '<td  colspan="2">P2= <input type="text" value="' + json[i].UsePressureShangP2 + '" id="p2' + rowCount + '" style="width:30px;"/>kPa</td>';
                    html += '<td  colspan="2">Pb= <input type="text" value="' + json[i].UsePressureShangPb + '" id="pb' + rowCount + '" style="width:30px;"/>kPa</td>';
                    html += '<td  colspan="2" rowspan="2">Pf= <input type="text" value="' + json[i].UsePressureShangPf + '" id="pf' + rowCount + '" style="width:30px;"/>kPa</td>';
                    html += '</tr>';
                    $("#DetailInfo").append(html);
                    html = '<tr  id ="DetailInfo' + rowCount + '">';
                    html += '<td  colspan="2">下台</td>';
                    html += '<td  colspan="2">P1= <input type="text" value="' + json[i].UsePressureShangP1 + '" id="xp1' + rowCount + '" style="width:30px;"/>MPa </td>';
                    html += '<td  colspan="2">P2= <input type="text" value="' + json[i].UsePressureShangP2 + '" id="xp2' + rowCount + '" style="width:30px;"/>kPa </td>';
                    html += '<td  colspan="2">Pb= <input type="text" value="' + json[i].UsePressureShangPb + '" id="xpb' + rowCount + '" style="width:30px;"/>kPa </td>';
