...
$(document).ready(function () {
    ...
    $("#btnSave").click(function () {
        ...
        for (var i = 0; i < tbody.rows.length; i++) {
            //var Productid = tbody.getElementsByTagName("tr")[i].cells[0].innerText;//document.getElementById("ProductID" + i).innerHTML;
        ...
        $.ajax({
            ...
            type: "Post",
            data: {
                RecordID: RecordID, ContactPerson: ContactPerson, Tel: Tel, UserInformation: UserInformation,
                SatisfiedDegree: SatisfiedDegree, ReturnVisit: ReturnVisit, HFID: HFID, Type: Type, Remark: Remark,
                CreateUser: CreateUser, CreateTime: CreateTime,
                Unit: Unit, ID: ID, Amount: Amount, Total: Total, UnitPrice: UnitPrice, ProductID: ProductID,
                MainContent: MainContent, SpecsModels: SpecsModels,
            },
            async: false,
