...
$(document).ready(function () {
    ...
    $('#SP').click(function () {
        ...
        if (rowid == null) {
            ...
            var PID = jQuery("#list").jqGrid('getRowData', rowid).TSID;
...
function jq() {
    ...
    jQuery("#list").jqGrid({
        ...
        colNames: ['处理过程', '客户反馈', '处理时间', '处理人', '记录人','审批状态','审批编号','投诉编号'],
        colModel: [
        ...
        { name: 'TSID', index: 'TSID', width: 200, align: "center" }
        ],
        pager: jQuery('#pager'),
        pgbuttons: true,
        rowNum: OnePageCount,
