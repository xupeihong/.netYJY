...
$(document).ready(function () {
    ...
    $("#btnSave").click(function () {
        ...
        var OrderContent = $("#OrderContent option:selected").text();
        ...
        //}
        $.ajax({
            url: "SaveWarrantyCard",
            type: "Post",
            data: {
                BXKID: BXKID, ContractID: ContractID, OrderContent: OrderContent, SpecsModels: SpecsModels, PID: PID,BuyDate:BuyDate,UserAdd:UserAdd,
